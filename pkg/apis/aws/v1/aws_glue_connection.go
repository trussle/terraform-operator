...
type AwsGlueConnectionSpec struct {
	...
	PhysicalConnectionRequirements	[]AwsGlueConnectionPhysicalConnectionRequirements	`json:"physical_connection_requirements"`
...
// AwsGlueConnectionPhysicalConnectionRequirements is a AwsGlueConnectionPhysicalConnectionRequirements
type AwsGlueConnectionPhysicalConnectionRequirements struct {
