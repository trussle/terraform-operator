...
type AwsIamRoleInterface interface {
	...
	Get(name string, options meta_v1.GetOptions) (*v1.AwsIamRole, error)
	List(opts meta_v1.ListOptions) (*v1.AwsIamRoleList, error)
...
func newAwsIamRoles(c *TrussleV1Client, namespace string) *awsIamRoles {
	return &awsIamRoles{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *awsIamRoles) Get(name string, options meta_v1.GetOptions) (result *v1.AwsIamRole, err error) {
...
func (c *awsIamRoles) List(opts meta_v1.ListOptions) (result *v1.AwsIamRoleList, err error) {
...
func (c *awsIamRoles) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsiamroles").
...
func (c *awsIamRoles) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsIamRoles) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsiamroles").
