...
type AwsRoute53ZoneInterface interface {
	Create(*v1.AwsRoute53Zone) (*v1.AwsRoute53Zone, error)
	Update(*v1.AwsRoute53Zone) (*v1.AwsRoute53Zone, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsRoute53Zone, error)
	List(opts meta_v1.ListOptions) (*v1.AwsRoute53ZoneList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsRoute53Zone, err error)
...
func newAwsRoute53Zones(c *TrussleV1Client, namespace string) *awsRoute53Zones {
...
func (c *awsRoute53Zones) Get(name string, options meta_v1.GetOptions) (result *v1.AwsRoute53Zone, err error) {
	result = &v1.AwsRoute53Zone{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsRoute53Zones) List(opts meta_v1.ListOptions) (result *v1.AwsRoute53ZoneList, err error) {
	result = &v1.AwsRoute53ZoneList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsroute53zones").
...
func (c *awsRoute53Zones) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsroute53zones").
...
func (c *awsRoute53Zones) Create(awsRoute53Zone *v1.AwsRoute53Zone) (result *v1.AwsRoute53Zone, err error) {
	result = &v1.AwsRoute53Zone{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsroute53zones").
...
func (c *awsRoute53Zones) Update(awsRoute53Zone *v1.AwsRoute53Zone) (result *v1.AwsRoute53Zone, err error) {
	result = &v1.AwsRoute53Zone{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsroute53zones").
...
func (c *awsRoute53Zones) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsRoute53Zones) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsroute53zones").
...
func (c *awsRoute53Zones) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsRoute53Zone, err error) {
	result = &v1.AwsRoute53Zone{}
