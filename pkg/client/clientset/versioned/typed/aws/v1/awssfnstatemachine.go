...
type AwsSfnStateMachineInterface interface {
	Create(*v1.AwsSfnStateMachine) (*v1.AwsSfnStateMachine, error)
	Update(*v1.AwsSfnStateMachine) (*v1.AwsSfnStateMachine, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsSfnStateMachine, error)
	List(opts meta_v1.ListOptions) (*v1.AwsSfnStateMachineList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsSfnStateMachine, err error)
...
func newAwsSfnStateMachines(c *TrussleV1Client, namespace string) *awsSfnStateMachines {
...
func (c *awsSfnStateMachines) Get(name string, options meta_v1.GetOptions) (result *v1.AwsSfnStateMachine, err error) {
	result = &v1.AwsSfnStateMachine{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsSfnStateMachines) List(opts meta_v1.ListOptions) (result *v1.AwsSfnStateMachineList, err error) {
	result = &v1.AwsSfnStateMachineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awssfnstatemachines").
...
func (c *awsSfnStateMachines) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awssfnstatemachines").
...
func (c *awsSfnStateMachines) Create(awsSfnStateMachine *v1.AwsSfnStateMachine) (result *v1.AwsSfnStateMachine, err error) {
	result = &v1.AwsSfnStateMachine{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awssfnstatemachines").
...
func (c *awsSfnStateMachines) Update(awsSfnStateMachine *v1.AwsSfnStateMachine) (result *v1.AwsSfnStateMachine, err error) {
	result = &v1.AwsSfnStateMachine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awssfnstatemachines").
...
func (c *awsSfnStateMachines) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsSfnStateMachines) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awssfnstatemachines").
...
func (c *awsSfnStateMachines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsSfnStateMachine, err error) {
	result = &v1.AwsSfnStateMachine{}
