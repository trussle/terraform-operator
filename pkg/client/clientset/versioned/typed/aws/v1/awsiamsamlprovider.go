...
type AwsIamSamlProviderInterface interface {
	Create(*v1.AwsIamSamlProvider) (*v1.AwsIamSamlProvider, error)
	Update(*v1.AwsIamSamlProvider) (*v1.AwsIamSamlProvider, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsIamSamlProvider, error)
	List(opts meta_v1.ListOptions) (*v1.AwsIamSamlProviderList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsIamSamlProvider, err error)
...
func newAwsIamSamlProviders(c *TrussleV1Client, namespace string) *awsIamSamlProviders {
...
func (c *awsIamSamlProviders) Get(name string, options meta_v1.GetOptions) (result *v1.AwsIamSamlProvider, err error) {
	result = &v1.AwsIamSamlProvider{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsIamSamlProviders) List(opts meta_v1.ListOptions) (result *v1.AwsIamSamlProviderList, err error) {
	result = &v1.AwsIamSamlProviderList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsiamsamlproviders").
...
func (c *awsIamSamlProviders) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsiamsamlproviders").
...
func (c *awsIamSamlProviders) Create(awsIamSamlProvider *v1.AwsIamSamlProvider) (result *v1.AwsIamSamlProvider, err error) {
	result = &v1.AwsIamSamlProvider{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsiamsamlproviders").
...
func (c *awsIamSamlProviders) Update(awsIamSamlProvider *v1.AwsIamSamlProvider) (result *v1.AwsIamSamlProvider, err error) {
	result = &v1.AwsIamSamlProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsiamsamlproviders").
...
func (c *awsIamSamlProviders) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsIamSamlProviders) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsiamsamlproviders").
...
func (c *awsIamSamlProviders) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsIamSamlProvider, err error) {
	result = &v1.AwsIamSamlProvider{}
