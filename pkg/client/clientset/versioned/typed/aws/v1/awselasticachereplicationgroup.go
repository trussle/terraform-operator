...
type AwsElasticacheReplicationGroupInterface interface {
	Create(*v1.AwsElasticacheReplicationGroup) (*v1.AwsElasticacheReplicationGroup, error)
	Update(*v1.AwsElasticacheReplicationGroup) (*v1.AwsElasticacheReplicationGroup, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsElasticacheReplicationGroup, error)
	List(opts meta_v1.ListOptions) (*v1.AwsElasticacheReplicationGroupList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsElasticacheReplicationGroup, err error)
...
func newAwsElasticacheReplicationGroups(c *TrussleV1Client, namespace string) *awsElasticacheReplicationGroups {
...
func (c *awsElasticacheReplicationGroups) Get(name string, options meta_v1.GetOptions) (result *v1.AwsElasticacheReplicationGroup, err error) {
	result = &v1.AwsElasticacheReplicationGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsElasticacheReplicationGroups) List(opts meta_v1.ListOptions) (result *v1.AwsElasticacheReplicationGroupList, err error) {
	result = &v1.AwsElasticacheReplicationGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awselasticachereplicationgroups").
...
func (c *awsElasticacheReplicationGroups) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awselasticachereplicationgroups").
...
func (c *awsElasticacheReplicationGroups) Create(awsElasticacheReplicationGroup *v1.AwsElasticacheReplicationGroup) (result *v1.AwsElasticacheReplicationGroup, err error) {
	result = &v1.AwsElasticacheReplicationGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awselasticachereplicationgroups").
...
func (c *awsElasticacheReplicationGroups) Update(awsElasticacheReplicationGroup *v1.AwsElasticacheReplicationGroup) (result *v1.AwsElasticacheReplicationGroup, err error) {
	result = &v1.AwsElasticacheReplicationGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awselasticachereplicationgroups").
...
func (c *awsElasticacheReplicationGroups) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsElasticacheReplicationGroups) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awselasticachereplicationgroups").
...
func (c *awsElasticacheReplicationGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsElasticacheReplicationGroup, err error) {
	result = &v1.AwsElasticacheReplicationGroup{}
