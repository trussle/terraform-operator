...
type AwsSsmParameterInterface interface {
	Create(*v1.AwsSsmParameter) (*v1.AwsSsmParameter, error)
	Update(*v1.AwsSsmParameter) (*v1.AwsSsmParameter, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsSsmParameter, error)
	List(opts meta_v1.ListOptions) (*v1.AwsSsmParameterList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsSsmParameter, err error)
...
func newAwsSsmParameters(c *TrussleV1Client, namespace string) *awsSsmParameters {
...
func (c *awsSsmParameters) Get(name string, options meta_v1.GetOptions) (result *v1.AwsSsmParameter, err error) {
	result = &v1.AwsSsmParameter{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsSsmParameters) List(opts meta_v1.ListOptions) (result *v1.AwsSsmParameterList, err error) {
	result = &v1.AwsSsmParameterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsssmparameters").
...
func (c *awsSsmParameters) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsssmparameters").
...
func (c *awsSsmParameters) Create(awsSsmParameter *v1.AwsSsmParameter) (result *v1.AwsSsmParameter, err error) {
	result = &v1.AwsSsmParameter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsssmparameters").
...
func (c *awsSsmParameters) Update(awsSsmParameter *v1.AwsSsmParameter) (result *v1.AwsSsmParameter, err error) {
	result = &v1.AwsSsmParameter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsssmparameters").
...
func (c *awsSsmParameters) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsSsmParameters) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsssmparameters").
...
func (c *awsSsmParameters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsSsmParameter, err error) {
	result = &v1.AwsSsmParameter{}
