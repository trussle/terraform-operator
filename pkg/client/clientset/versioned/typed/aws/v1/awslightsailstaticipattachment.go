...
type AwsLightsailStaticIpAttachmentInterface interface {
	Create(*v1.AwsLightsailStaticIpAttachment) (*v1.AwsLightsailStaticIpAttachment, error)
	Update(*v1.AwsLightsailStaticIpAttachment) (*v1.AwsLightsailStaticIpAttachment, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsLightsailStaticIpAttachment, error)
	List(opts meta_v1.ListOptions) (*v1.AwsLightsailStaticIpAttachmentList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsLightsailStaticIpAttachment, err error)
...
func newAwsLightsailStaticIpAttachments(c *TrussleV1Client, namespace string) *awsLightsailStaticIpAttachments {
...
func (c *awsLightsailStaticIpAttachments) Get(name string, options meta_v1.GetOptions) (result *v1.AwsLightsailStaticIpAttachment, err error) {
	result = &v1.AwsLightsailStaticIpAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsLightsailStaticIpAttachments) List(opts meta_v1.ListOptions) (result *v1.AwsLightsailStaticIpAttachmentList, err error) {
	result = &v1.AwsLightsailStaticIpAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awslightsailstaticipattachments").
...
func (c *awsLightsailStaticIpAttachments) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awslightsailstaticipattachments").
...
func (c *awsLightsailStaticIpAttachments) Create(awsLightsailStaticIpAttachment *v1.AwsLightsailStaticIpAttachment) (result *v1.AwsLightsailStaticIpAttachment, err error) {
	result = &v1.AwsLightsailStaticIpAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awslightsailstaticipattachments").
...
func (c *awsLightsailStaticIpAttachments) Update(awsLightsailStaticIpAttachment *v1.AwsLightsailStaticIpAttachment) (result *v1.AwsLightsailStaticIpAttachment, err error) {
	result = &v1.AwsLightsailStaticIpAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awslightsailstaticipattachments").
...
func (c *awsLightsailStaticIpAttachments) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsLightsailStaticIpAttachments) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awslightsailstaticipattachments").
...
func (c *awsLightsailStaticIpAttachments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsLightsailStaticIpAttachment, err error) {
	result = &v1.AwsLightsailStaticIpAttachment{}
