...
type AwsApiGatewayVpcLinkInterface interface {
	Create(*v1.AwsApiGatewayVpcLink) (*v1.AwsApiGatewayVpcLink, error)
	Update(*v1.AwsApiGatewayVpcLink) (*v1.AwsApiGatewayVpcLink, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsApiGatewayVpcLink, error)
	List(opts meta_v1.ListOptions) (*v1.AwsApiGatewayVpcLinkList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsApiGatewayVpcLink, err error)
...
func newAwsApiGatewayVpcLinks(c *TrussleV1Client, namespace string) *awsApiGatewayVpcLinks {
...
func (c *awsApiGatewayVpcLinks) Get(name string, options meta_v1.GetOptions) (result *v1.AwsApiGatewayVpcLink, err error) {
	result = &v1.AwsApiGatewayVpcLink{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsApiGatewayVpcLinks) List(opts meta_v1.ListOptions) (result *v1.AwsApiGatewayVpcLinkList, err error) {
	result = &v1.AwsApiGatewayVpcLinkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsapigatewayvpclinks").
...
func (c *awsApiGatewayVpcLinks) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsapigatewayvpclinks").
...
func (c *awsApiGatewayVpcLinks) Create(awsApiGatewayVpcLink *v1.AwsApiGatewayVpcLink) (result *v1.AwsApiGatewayVpcLink, err error) {
	result = &v1.AwsApiGatewayVpcLink{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsapigatewayvpclinks").
...
func (c *awsApiGatewayVpcLinks) Update(awsApiGatewayVpcLink *v1.AwsApiGatewayVpcLink) (result *v1.AwsApiGatewayVpcLink, err error) {
	result = &v1.AwsApiGatewayVpcLink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsapigatewayvpclinks").
...
func (c *awsApiGatewayVpcLinks) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsApiGatewayVpcLinks) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsapigatewayvpclinks").
...
func (c *awsApiGatewayVpcLinks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsApiGatewayVpcLink, err error) {
	result = &v1.AwsApiGatewayVpcLink{}
