...
type AwsIamAccountAliasInterface interface {
	Create(*v1.AwsIamAccountAlias) (*v1.AwsIamAccountAlias, error)
	Update(*v1.AwsIamAccountAlias) (*v1.AwsIamAccountAlias, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsIamAccountAlias, error)
	List(opts meta_v1.ListOptions) (*v1.AwsIamAccountAliasList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsIamAccountAlias, err error)
...
func newAwsIamAccountAliases(c *TrussleV1Client, namespace string) *awsIamAccountAliases {
...
func (c *awsIamAccountAliases) Get(name string, options meta_v1.GetOptions) (result *v1.AwsIamAccountAlias, err error) {
	result = &v1.AwsIamAccountAlias{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsIamAccountAliases) List(opts meta_v1.ListOptions) (result *v1.AwsIamAccountAliasList, err error) {
	result = &v1.AwsIamAccountAliasList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsiamaccountaliases").
...
func (c *awsIamAccountAliases) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsiamaccountaliases").
...
func (c *awsIamAccountAliases) Create(awsIamAccountAlias *v1.AwsIamAccountAlias) (result *v1.AwsIamAccountAlias, err error) {
	result = &v1.AwsIamAccountAlias{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsiamaccountaliases").
...
func (c *awsIamAccountAliases) Update(awsIamAccountAlias *v1.AwsIamAccountAlias) (result *v1.AwsIamAccountAlias, err error) {
	result = &v1.AwsIamAccountAlias{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsiamaccountaliases").
...
func (c *awsIamAccountAliases) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsIamAccountAliases) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsiamaccountaliases").
...
func (c *awsIamAccountAliases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsIamAccountAlias, err error) {
	result = &v1.AwsIamAccountAlias{}
