...
type AwsSsmPatchBaselineInterface interface {
	Create(*v1.AwsSsmPatchBaseline) (*v1.AwsSsmPatchBaseline, error)
	Update(*v1.AwsSsmPatchBaseline) (*v1.AwsSsmPatchBaseline, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsSsmPatchBaseline, error)
	List(opts meta_v1.ListOptions) (*v1.AwsSsmPatchBaselineList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsSsmPatchBaseline, err error)
...
func newAwsSsmPatchBaselines(c *TrussleV1Client, namespace string) *awsSsmPatchBaselines {
...
func (c *awsSsmPatchBaselines) Get(name string, options meta_v1.GetOptions) (result *v1.AwsSsmPatchBaseline, err error) {
	result = &v1.AwsSsmPatchBaseline{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsSsmPatchBaselines) List(opts meta_v1.ListOptions) (result *v1.AwsSsmPatchBaselineList, err error) {
	result = &v1.AwsSsmPatchBaselineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsssmpatchbaselines").
...
func (c *awsSsmPatchBaselines) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsssmpatchbaselines").
...
func (c *awsSsmPatchBaselines) Create(awsSsmPatchBaseline *v1.AwsSsmPatchBaseline) (result *v1.AwsSsmPatchBaseline, err error) {
	result = &v1.AwsSsmPatchBaseline{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsssmpatchbaselines").
...
func (c *awsSsmPatchBaselines) Update(awsSsmPatchBaseline *v1.AwsSsmPatchBaseline) (result *v1.AwsSsmPatchBaseline, err error) {
	result = &v1.AwsSsmPatchBaseline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsssmpatchbaselines").
...
func (c *awsSsmPatchBaselines) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsSsmPatchBaselines) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsssmpatchbaselines").
...
func (c *awsSsmPatchBaselines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsSsmPatchBaseline, err error) {
	result = &v1.AwsSsmPatchBaseline{}
