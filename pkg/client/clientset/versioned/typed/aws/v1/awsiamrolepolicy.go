...
type AwsIamRolePolicyInterface interface {
	Create(*v1.AwsIamRolePolicy) (*v1.AwsIamRolePolicy, error)
	Update(*v1.AwsIamRolePolicy) (*v1.AwsIamRolePolicy, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsIamRolePolicy, error)
	List(opts meta_v1.ListOptions) (*v1.AwsIamRolePolicyList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsIamRolePolicy, err error)
...
func newAwsIamRolePolicies(c *TrussleV1Client, namespace string) *awsIamRolePolicies {
...
func (c *awsIamRolePolicies) Get(name string, options meta_v1.GetOptions) (result *v1.AwsIamRolePolicy, err error) {
	result = &v1.AwsIamRolePolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsIamRolePolicies) List(opts meta_v1.ListOptions) (result *v1.AwsIamRolePolicyList, err error) {
	result = &v1.AwsIamRolePolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsiamrolepolicies").
...
func (c *awsIamRolePolicies) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsiamrolepolicies").
...
func (c *awsIamRolePolicies) Create(awsIamRolePolicy *v1.AwsIamRolePolicy) (result *v1.AwsIamRolePolicy, err error) {
	result = &v1.AwsIamRolePolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsiamrolepolicies").
...
func (c *awsIamRolePolicies) Update(awsIamRolePolicy *v1.AwsIamRolePolicy) (result *v1.AwsIamRolePolicy, err error) {
	result = &v1.AwsIamRolePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsiamrolepolicies").
...
func (c *awsIamRolePolicies) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsIamRolePolicies) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsiamrolepolicies").
...
func (c *awsIamRolePolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsIamRolePolicy, err error) {
	result = &v1.AwsIamRolePolicy{}
