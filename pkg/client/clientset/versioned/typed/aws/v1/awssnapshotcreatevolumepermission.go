...
type AwsSnapshotCreateVolumePermissionInterface interface {
	Create(*v1.AwsSnapshotCreateVolumePermission) (*v1.AwsSnapshotCreateVolumePermission, error)
	Update(*v1.AwsSnapshotCreateVolumePermission) (*v1.AwsSnapshotCreateVolumePermission, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsSnapshotCreateVolumePermission, error)
	List(opts meta_v1.ListOptions) (*v1.AwsSnapshotCreateVolumePermissionList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsSnapshotCreateVolumePermission, err error)
...
func newAwsSnapshotCreateVolumePermissions(c *TrussleV1Client, namespace string) *awsSnapshotCreateVolumePermissions {
...
func (c *awsSnapshotCreateVolumePermissions) Get(name string, options meta_v1.GetOptions) (result *v1.AwsSnapshotCreateVolumePermission, err error) {
	result = &v1.AwsSnapshotCreateVolumePermission{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsSnapshotCreateVolumePermissions) List(opts meta_v1.ListOptions) (result *v1.AwsSnapshotCreateVolumePermissionList, err error) {
	result = &v1.AwsSnapshotCreateVolumePermissionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awssnapshotcreatevolumepermissions").
...
func (c *awsSnapshotCreateVolumePermissions) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awssnapshotcreatevolumepermissions").
...
func (c *awsSnapshotCreateVolumePermissions) Create(awsSnapshotCreateVolumePermission *v1.AwsSnapshotCreateVolumePermission) (result *v1.AwsSnapshotCreateVolumePermission, err error) {
	result = &v1.AwsSnapshotCreateVolumePermission{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awssnapshotcreatevolumepermissions").
...
func (c *awsSnapshotCreateVolumePermissions) Update(awsSnapshotCreateVolumePermission *v1.AwsSnapshotCreateVolumePermission) (result *v1.AwsSnapshotCreateVolumePermission, err error) {
	result = &v1.AwsSnapshotCreateVolumePermission{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awssnapshotcreatevolumepermissions").
...
func (c *awsSnapshotCreateVolumePermissions) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsSnapshotCreateVolumePermissions) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awssnapshotcreatevolumepermissions").
...
func (c *awsSnapshotCreateVolumePermissions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsSnapshotCreateVolumePermission, err error) {
	result = &v1.AwsSnapshotCreateVolumePermission{}
