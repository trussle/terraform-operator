...
type AwsRedshiftSubnetGroupInterface interface {
	Create(*v1.AwsRedshiftSubnetGroup) (*v1.AwsRedshiftSubnetGroup, error)
	Update(*v1.AwsRedshiftSubnetGroup) (*v1.AwsRedshiftSubnetGroup, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsRedshiftSubnetGroup, error)
	List(opts meta_v1.ListOptions) (*v1.AwsRedshiftSubnetGroupList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsRedshiftSubnetGroup, err error)
...
func newAwsRedshiftSubnetGroups(c *TrussleV1Client, namespace string) *awsRedshiftSubnetGroups {
...
func (c *awsRedshiftSubnetGroups) Get(name string, options meta_v1.GetOptions) (result *v1.AwsRedshiftSubnetGroup, err error) {
	result = &v1.AwsRedshiftSubnetGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsRedshiftSubnetGroups) List(opts meta_v1.ListOptions) (result *v1.AwsRedshiftSubnetGroupList, err error) {
	result = &v1.AwsRedshiftSubnetGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsredshiftsubnetgroups").
...
func (c *awsRedshiftSubnetGroups) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsredshiftsubnetgroups").
...
func (c *awsRedshiftSubnetGroups) Create(awsRedshiftSubnetGroup *v1.AwsRedshiftSubnetGroup) (result *v1.AwsRedshiftSubnetGroup, err error) {
	result = &v1.AwsRedshiftSubnetGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsredshiftsubnetgroups").
...
func (c *awsRedshiftSubnetGroups) Update(awsRedshiftSubnetGroup *v1.AwsRedshiftSubnetGroup) (result *v1.AwsRedshiftSubnetGroup, err error) {
	result = &v1.AwsRedshiftSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsredshiftsubnetgroups").
...
func (c *awsRedshiftSubnetGroups) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsRedshiftSubnetGroups) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsredshiftsubnetgroups").
...
func (c *awsRedshiftSubnetGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsRedshiftSubnetGroup, err error) {
	result = &v1.AwsRedshiftSubnetGroup{}
