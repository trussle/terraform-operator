...
type AwsLightsailInstanceInterface interface {
	Create(*v1.AwsLightsailInstance) (*v1.AwsLightsailInstance, error)
	Update(*v1.AwsLightsailInstance) (*v1.AwsLightsailInstance, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsLightsailInstance, error)
	List(opts meta_v1.ListOptions) (*v1.AwsLightsailInstanceList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsLightsailInstance, err error)
...
func newAwsLightsailInstances(c *TrussleV1Client, namespace string) *awsLightsailInstances {
...
func (c *awsLightsailInstances) Get(name string, options meta_v1.GetOptions) (result *v1.AwsLightsailInstance, err error) {
	result = &v1.AwsLightsailInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsLightsailInstances) List(opts meta_v1.ListOptions) (result *v1.AwsLightsailInstanceList, err error) {
	result = &v1.AwsLightsailInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awslightsailinstances").
...
func (c *awsLightsailInstances) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awslightsailinstances").
...
func (c *awsLightsailInstances) Create(awsLightsailInstance *v1.AwsLightsailInstance) (result *v1.AwsLightsailInstance, err error) {
	result = &v1.AwsLightsailInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awslightsailinstances").
...
func (c *awsLightsailInstances) Update(awsLightsailInstance *v1.AwsLightsailInstance) (result *v1.AwsLightsailInstance, err error) {
	result = &v1.AwsLightsailInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awslightsailinstances").
...
func (c *awsLightsailInstances) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsLightsailInstances) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awslightsailinstances").
...
func (c *awsLightsailInstances) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsLightsailInstance, err error) {
	result = &v1.AwsLightsailInstance{}
