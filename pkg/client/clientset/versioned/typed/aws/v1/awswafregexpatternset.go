...
type AwsWafRegexPatternSetInterface interface {
	Create(*v1.AwsWafRegexPatternSet) (*v1.AwsWafRegexPatternSet, error)
	Update(*v1.AwsWafRegexPatternSet) (*v1.AwsWafRegexPatternSet, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsWafRegexPatternSet, error)
	List(opts meta_v1.ListOptions) (*v1.AwsWafRegexPatternSetList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsWafRegexPatternSet, err error)
...
func newAwsWafRegexPatternSets(c *TrussleV1Client, namespace string) *awsWafRegexPatternSets {
...
func (c *awsWafRegexPatternSets) Get(name string, options meta_v1.GetOptions) (result *v1.AwsWafRegexPatternSet, err error) {
	result = &v1.AwsWafRegexPatternSet{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsWafRegexPatternSets) List(opts meta_v1.ListOptions) (result *v1.AwsWafRegexPatternSetList, err error) {
	result = &v1.AwsWafRegexPatternSetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awswafregexpatternsets").
...
func (c *awsWafRegexPatternSets) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awswafregexpatternsets").
...
func (c *awsWafRegexPatternSets) Create(awsWafRegexPatternSet *v1.AwsWafRegexPatternSet) (result *v1.AwsWafRegexPatternSet, err error) {
	result = &v1.AwsWafRegexPatternSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awswafregexpatternsets").
...
func (c *awsWafRegexPatternSets) Update(awsWafRegexPatternSet *v1.AwsWafRegexPatternSet) (result *v1.AwsWafRegexPatternSet, err error) {
	result = &v1.AwsWafRegexPatternSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awswafregexpatternsets").
...
func (c *awsWafRegexPatternSets) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsWafRegexPatternSets) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awswafregexpatternsets").
...
func (c *awsWafRegexPatternSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsWafRegexPatternSet, err error) {
	result = &v1.AwsWafRegexPatternSet{}
