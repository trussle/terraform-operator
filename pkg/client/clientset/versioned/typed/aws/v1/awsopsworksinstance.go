...
type AwsOpsworksInstanceInterface interface {
	Create(*v1.AwsOpsworksInstance) (*v1.AwsOpsworksInstance, error)
	Update(*v1.AwsOpsworksInstance) (*v1.AwsOpsworksInstance, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsOpsworksInstance, error)
	List(opts meta_v1.ListOptions) (*v1.AwsOpsworksInstanceList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsOpsworksInstance, err error)
...
func newAwsOpsworksInstances(c *TrussleV1Client, namespace string) *awsOpsworksInstances {
...
func (c *awsOpsworksInstances) Get(name string, options meta_v1.GetOptions) (result *v1.AwsOpsworksInstance, err error) {
	result = &v1.AwsOpsworksInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsOpsworksInstances) List(opts meta_v1.ListOptions) (result *v1.AwsOpsworksInstanceList, err error) {
	result = &v1.AwsOpsworksInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsopsworksinstances").
...
func (c *awsOpsworksInstances) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsopsworksinstances").
...
func (c *awsOpsworksInstances) Create(awsOpsworksInstance *v1.AwsOpsworksInstance) (result *v1.AwsOpsworksInstance, err error) {
	result = &v1.AwsOpsworksInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsopsworksinstances").
...
func (c *awsOpsworksInstances) Update(awsOpsworksInstance *v1.AwsOpsworksInstance) (result *v1.AwsOpsworksInstance, err error) {
	result = &v1.AwsOpsworksInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsopsworksinstances").
...
func (c *awsOpsworksInstances) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsOpsworksInstances) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsopsworksinstances").
...
func (c *awsOpsworksInstances) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsOpsworksInstance, err error) {
	result = &v1.AwsOpsworksInstance{}
