...
type AwsAthenaNamedQueryInterface interface {
	Create(*v1.AwsAthenaNamedQuery) (*v1.AwsAthenaNamedQuery, error)
	Update(*v1.AwsAthenaNamedQuery) (*v1.AwsAthenaNamedQuery, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.AwsAthenaNamedQuery, error)
	List(opts meta_v1.ListOptions) (*v1.AwsAthenaNamedQueryList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsAthenaNamedQuery, err error)
...
func newAwsAthenaNamedQueries(c *TrussleV1Client, namespace string) *awsAthenaNamedQueries {
...
func (c *awsAthenaNamedQueries) Get(name string, options meta_v1.GetOptions) (result *v1.AwsAthenaNamedQuery, err error) {
	result = &v1.AwsAthenaNamedQuery{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsAthenaNamedQueries) List(opts meta_v1.ListOptions) (result *v1.AwsAthenaNamedQueryList, err error) {
	result = &v1.AwsAthenaNamedQueryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsathenanamedqueries").
...
func (c *awsAthenaNamedQueries) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("awsathenanamedqueries").
...
func (c *awsAthenaNamedQueries) Create(awsAthenaNamedQuery *v1.AwsAthenaNamedQuery) (result *v1.AwsAthenaNamedQuery, err error) {
	result = &v1.AwsAthenaNamedQuery{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsathenanamedqueries").
...
func (c *awsAthenaNamedQueries) Update(awsAthenaNamedQuery *v1.AwsAthenaNamedQuery) (result *v1.AwsAthenaNamedQuery, err error) {
	result = &v1.AwsAthenaNamedQuery{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsathenanamedqueries").
...
func (c *awsAthenaNamedQueries) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *awsAthenaNamedQueries) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("awsathenanamedqueries").
...
func (c *awsAthenaNamedQueries) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.AwsAthenaNamedQuery, err error) {
	result = &v1.AwsAthenaNamedQuery{}
