...
type AwsVpcLister interface {
	...
	List(selector labels.Selector) (ret []*v1.AwsVpc, err error)
...
// List lists all AwsVpcs in the indexer.
func (s *awsVpcLister) List(selector labels.Selector) (ret []*v1.AwsVpc, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1.AwsVpc))
	})
	return ret, err
}
...
type AwsVpcNamespaceLister interface {
	...
	Get(name string) (*v1.AwsVpc, error)
...
// List lists all AwsVpcs in the indexer for a given namespace.
func (s awsVpcNamespaceLister) List(selector labels.Selector) (ret []*v1.AwsVpc, err error) {
...
// Get retrieves the AwsVpc from the indexer for a given namespace and name.
func (s awsVpcNamespaceLister) Get(name string) (*v1.AwsVpc, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("awsvpc"), name)
	}
	return obj.(*v1.AwsVpc), nil
}
