...
type AwsWafregionalSqlInjectionMatchSetLister interface {
	...
	List(selector labels.Selector) (ret []*v1.AwsWafregionalSqlInjectionMatchSet, err error)
...
// List lists all AwsWafregionalSqlInjectionMatchSets in the indexer.
func (s *awsWafregionalSqlInjectionMatchSetLister) List(selector labels.Selector) (ret []*v1.AwsWafregionalSqlInjectionMatchSet, err error) {
...
type AwsWafregionalSqlInjectionMatchSetNamespaceLister interface {
	...
	Get(name string) (*v1.AwsWafregionalSqlInjectionMatchSet, error)
