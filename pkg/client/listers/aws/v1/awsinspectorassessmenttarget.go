...
type AwsInspectorAssessmentTargetLister interface {
	...
	List(selector labels.Selector) (ret []*v1.AwsInspectorAssessmentTarget, err error)
...
// List lists all AwsInspectorAssessmentTargets in the indexer.
func (s *awsInspectorAssessmentTargetLister) List(selector labels.Selector) (ret []*v1.AwsInspectorAssessmentTarget, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1.AwsInspectorAssessmentTarget))
	})
	return ret, err
}
...
type AwsInspectorAssessmentTargetNamespaceLister interface {
	...
	Get(name string) (*v1.AwsInspectorAssessmentTarget, error)
...
// List lists all AwsInspectorAssessmentTargets in the indexer for a given namespace.
func (s awsInspectorAssessmentTargetNamespaceLister) List(selector labels.Selector) (ret []*v1.AwsInspectorAssessmentTarget, err error) {
...
// Get retrieves the AwsInspectorAssessmentTarget from the indexer for a given namespace and name.
func (s awsInspectorAssessmentTargetNamespaceLister) Get(name string) (*v1.AwsInspectorAssessmentTarget, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("awsinspectorassessmenttarget"), name)
	}
	return obj.(*v1.AwsInspectorAssessmentTarget), nil
}
