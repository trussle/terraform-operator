...
type AwsElastictranscoderPresetInformer interface {
	...
	Lister() v1.AwsElastictranscoderPresetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrussleV1().AwsElastictranscoderPresets(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrussleV1().AwsElastictranscoderPresets(namespace).Watch(options)
			},
		},
		&aws_v1.AwsElastictranscoderPreset{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsElastictranscoderPresetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1.AwsElastictranscoderPreset{}, f.defaultInformer)
}

func (f *awsElastictranscoderPresetInformer) Lister() v1.AwsElastictranscoderPresetLister {
	return v1.NewAwsElastictranscoderPresetLister(f.Informer().GetIndexer())
}
