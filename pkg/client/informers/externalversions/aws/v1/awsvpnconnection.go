...
type AwsVpnConnectionInformer interface {
	...
	Lister() v1.AwsVpnConnectionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrussleV1().AwsVpnConnections(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrussleV1().AwsVpnConnections(namespace).Watch(options)
			},
		},
		&aws_v1.AwsVpnConnection{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsVpnConnectionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1.AwsVpnConnection{}, f.defaultInformer)
}

func (f *awsVpnConnectionInformer) Lister() v1.AwsVpnConnectionLister {
	return v1.NewAwsVpnConnectionLister(f.Informer().GetIndexer())
}
