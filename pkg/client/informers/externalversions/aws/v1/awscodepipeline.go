...
type AwsCodepipelineInformer interface {
	...
	Lister() v1.AwsCodepipelineLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrussleV1().AwsCodepipelines(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrussleV1().AwsCodepipelines(namespace).Watch(options)
			},
		},
		&aws_v1.AwsCodepipeline{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsCodepipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1.AwsCodepipeline{}, f.defaultInformer)
}

func (f *awsCodepipelineInformer) Lister() v1.AwsCodepipelineLister {
	return v1.NewAwsCodepipelineLister(f.Informer().GetIndexer())
}
