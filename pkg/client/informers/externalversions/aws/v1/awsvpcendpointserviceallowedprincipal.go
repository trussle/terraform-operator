...
type AwsVpcEndpointServiceAllowedPrincipalInformer interface {
	...
	Lister() v1.AwsVpcEndpointServiceAllowedPrincipalLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrussleV1().AwsVpcEndpointServiceAllowedPrincipals(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrussleV1().AwsVpcEndpointServiceAllowedPrincipals(namespace).Watch(options)
			},
		},
		&aws_v1.AwsVpcEndpointServiceAllowedPrincipal{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsVpcEndpointServiceAllowedPrincipalInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1.AwsVpcEndpointServiceAllowedPrincipal{}, f.defaultInformer)
}

func (f *awsVpcEndpointServiceAllowedPrincipalInformer) Lister() v1.AwsVpcEndpointServiceAllowedPrincipalLister {
	return v1.NewAwsVpcEndpointServiceAllowedPrincipalLister(f.Informer().GetIndexer())
}
