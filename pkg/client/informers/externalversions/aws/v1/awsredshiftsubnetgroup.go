...
type AwsRedshiftSubnetGroupInformer interface {
	...
	Lister() v1.AwsRedshiftSubnetGroupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrussleV1().AwsRedshiftSubnetGroups(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrussleV1().AwsRedshiftSubnetGroups(namespace).Watch(options)
			},
		},
		&aws_v1.AwsRedshiftSubnetGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsRedshiftSubnetGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1.AwsRedshiftSubnetGroup{}, f.defaultInformer)
}

func (f *awsRedshiftSubnetGroupInformer) Lister() v1.AwsRedshiftSubnetGroupLister {
	return v1.NewAwsRedshiftSubnetGroupLister(f.Informer().GetIndexer())
}
