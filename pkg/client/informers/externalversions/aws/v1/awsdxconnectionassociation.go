...
type AwsDxConnectionAssociationInformer interface {
	...
	Lister() v1.AwsDxConnectionAssociationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrussleV1().AwsDxConnectionAssociations(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrussleV1().AwsDxConnectionAssociations(namespace).Watch(options)
			},
		},
		&aws_v1.AwsDxConnectionAssociation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsDxConnectionAssociationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1.AwsDxConnectionAssociation{}, f.defaultInformer)
}

func (f *awsDxConnectionAssociationInformer) Lister() v1.AwsDxConnectionAssociationLister {
	return v1.NewAwsDxConnectionAssociationLister(f.Informer().GetIndexer())
}
