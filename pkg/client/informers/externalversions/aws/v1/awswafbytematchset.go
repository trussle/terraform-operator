...
type AwsWafByteMatchSetInformer interface {
	...
	Lister() v1.AwsWafByteMatchSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrussleV1().AwsWafByteMatchSets(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrussleV1().AwsWafByteMatchSets(namespace).Watch(options)
			},
		},
		&aws_v1.AwsWafByteMatchSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsWafByteMatchSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1.AwsWafByteMatchSet{}, f.defaultInformer)
}

func (f *awsWafByteMatchSetInformer) Lister() v1.AwsWafByteMatchSetLister {
	return v1.NewAwsWafByteMatchSetLister(f.Informer().GetIndexer())
}
