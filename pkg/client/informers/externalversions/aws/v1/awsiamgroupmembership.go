...
type AwsIamGroupMembershipInformer interface {
	...
	Lister() v1.AwsIamGroupMembershipLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrussleV1().AwsIamGroupMemberships(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrussleV1().AwsIamGroupMemberships(namespace).Watch(options)
			},
		},
		&aws_v1.AwsIamGroupMembership{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsIamGroupMembershipInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1.AwsIamGroupMembership{}, f.defaultInformer)
}

func (f *awsIamGroupMembershipInformer) Lister() v1.AwsIamGroupMembershipLister {
	return v1.NewAwsIamGroupMembershipLister(f.Informer().GetIndexer())
}
