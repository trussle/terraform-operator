...
type AwsEfsFileSystemInformer interface {
	...
	Lister() v1.AwsEfsFileSystemLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrussleV1().AwsEfsFileSystems(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrussleV1().AwsEfsFileSystems(namespace).Watch(options)
			},
		},
		&aws_v1.AwsEfsFileSystem{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsEfsFileSystemInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1.AwsEfsFileSystem{}, f.defaultInformer)
}

func (f *awsEfsFileSystemInformer) Lister() v1.AwsEfsFileSystemLister {
	return v1.NewAwsEfsFileSystemLister(f.Informer().GetIndexer())
}
